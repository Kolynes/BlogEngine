"""
Django settings for UBlogger project.
...
SECRET_KEY = ')moci_owv1rn*o6b^key38#2lzt1kwsqr2mdc%bvd_^6@6njun'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#The following hosts are for development purposes.
ALLOWED_HOSTS = [
    "127.0.0.1",
    "192.168.43.70" 
]
...
INSTALLED_APPS = [
    ...
    'UBloggerApp.apps.UbloggerappConfig',
...
WSGI_APPLICATION = 'UBlogger.wsgi.application'
